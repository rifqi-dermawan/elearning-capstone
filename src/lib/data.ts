import { Modul, UserLog } from "@/types";

export const daftarModul: Modul[] = [
  {
    id: "m1",
    title: "Dasar HTML & CSS",
    description: "Belajar struktur web",
    tags: ["Web", "Frontend"],
  },
  {
    id: "m2",
    title: "Javascript Modern",
    description: "Logic di frontend",
    tags: ["Web", "Javascript"],
  },
  {
    id: "m3",
    title: "Pengenalan Database",
    description: "Simpan data dengan MySQL",
  ...
  },
  {
    ...
    tags: ["Web", "Backend", "NextJS"],
  },
  {
    id: "m5",
    title: "AI Fundamentals",
    description: "Konsep dasar AI",
    tags: ["AI", "Data Science"],
  },
  {
    id: "m6",
    title: "React Hooks",
    description: "State management di React",
    tags: ["Web", "Frontend", "React"],
  },
  {
    id: "m8",
    title: "Neural Networks 101",
    description: "Belajar arsitektur otak buatan untuk pemula.",
    tags: ["AI"],
  },
  {
    id: "m9",
    title: "Data Science with Python",
    description: "Mengolah data menjadi informasi berharga.",
    tags: ["AI", "Data Science"],
  },
];

// Data 5 User Dummy dengan histori berbeda
